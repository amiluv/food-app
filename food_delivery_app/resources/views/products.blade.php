...
<main class="container my-5" style="max-width: 900px">
    <div class="row"> @if ($errors->any()) <div class="col-12"> @foreach ($errors->all() as $error) <div class="alert
        alert-danger">{{$error}}</div> @endforeach </div> @endif @if(session()->has('success')) <div
        ...
        <div class="col-12 col-md-6">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-8">
                            <div class="fw-bold">{{$product->name}} | Price: &#8358;{{$product->price}}
                            </div>
